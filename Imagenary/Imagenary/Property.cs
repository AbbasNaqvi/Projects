...
namespace Imagenary
{
    ...
    class Property : PostalAdress
    {
        ...
        public void SetAdressAutomatically()
        {
            //Must Change

            string temp = (ORD + ", " + ORC + ", " + SBN + ", " + BNA + ", " + POB + ", " + NUM + ", " + DST + ", " + STM + ", " + DDL + ", " + DLO + ", " + PTN + ", " + PCD).Trim().Replace(", ,", ",");
            //adress = //.ToLower().Replace(" ", "")
            if (temp.StartsWith(", "))
            {
                adress = temp.Remove(0, 2);
            }
        }
